function [DM] = GenXD_ort(TM, Types, Jitter, Ranges)
    ...
    for ty = 1:numel(Types)
        ...
        switch Type 
            ...
            R = Ranges(2, :);
            Unite = {[4, 5]; [6, 7]}; UN = ["L2-tgr", "L1-tgr"];
            case "USfinal"
            ...
            Unite = {[2, 3]}; UN = ["L1-tgr"];
            case "CS1tls"
            NewDesign = {2, 8, [8, 2], 1, 7};
            R = Ranges(1, :);
            Unite = {[2, 3]}; UN = ["L1-tgr"];
            case "CS2tl"
            NewDesign = {2, 3, [2,3], 9, [9,3], 1};
            R = Ranges(2, :);
            Unite = {[4, 5]}; UN = "L2-tgr";
            case "CS2tls"
            NewDesign = {2, 3, [2,3], 9, [9,3], 1, 7};
            R = Ranges(2, :);
            Unite = {[4, 5]}; UN = "L2-tgr";
...
%             case "surUSext"
%             NewDesign = {2, 4, 16, 17, [2,4], 7, 1};
%             Unite = {[3, 4]}; UN = ["sur2US-tgr"];
%             R = Ranges(3, :);
%             case "surUSred"    
%             NewDesign = {2, 4, 16, 17, [2,4]};
%             R = Ranges(3, :);
%             Unite = {[3, 4]}; UN = ["sur2US-tgr"];
%             case "sur12US"    
%             NewDesign = {2, 4, 20, 21};
...
%             Unite = {[3, 4]}; UN = ["sur12US-tgr"];
%             case "CS1red"
%             NewDesign = {2, 8, [8, 2], 12, 13};
%             R = Ranges(1, :);
%             Unite = {[2, 3]; [4, 5]}; UN = ["L1-tgr", "MAB-tgr"];
%             case "CS2red"
%             NewDesign = {2, 3, [2,3], 9, [9,3]};
%             R = Ranges(2, :);
%             Unite = {[4, 5]}; UN = "L2-tgr";
%             case "USred"
%             NewDesign = {2, 3, 4, [2,4], [3,4]};
%             R = Ranges(3, :);
%             case "CS1first"
%             NewDesign = {2};
%             R = Ranges(1, :);
...
%             Unite = {[2, 3]; [4, 5]}; UN = ["L1-tgr", "MAB-tgr"];
%             case "surCS2ext"
%             NewDesign = {3, 14, 15, 9, [9,3], 7, 1, Jitter};
%             Unite = {[2, 3]; [4, 5]}; UN = ["surCS2-tgr", "L1-tgr"];
%             R = Ranges(2, :);
%             case "surCS2red"    
%             NewDesign = {3, 14, 15, 9, [9,3]};
%             Unite = {[2, 3]; [4, 5]}; UN = ["surCS2-tgr", "L1-tgr"];
%             R = Ranges(2, :);
%             case "surCS2first"
%             NewDesign = {3, 14, 15};

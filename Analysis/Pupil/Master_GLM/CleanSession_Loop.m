...
for s = 29:34
    ...
    for m = 1:size(Matrices.Pupil.matrix,1)
        ...
        parsave_img("C:\GitHub\TD22\Analysis\Pupil\Master_GLM\Artifacts", "session_" + s + "_mouse_" + Matrices.Pupil.mouse(m), 0, 1, 0)
        sgtitle("Mouse " + Matrices.Pupil.mouse(m) + ", session " + s);
        close gcf
    end
    parsave("C:\GitHub\TD22\Analysis\Pupil\Master_GLM\Sessions\CleanSession_" + num2str(s), Matrices)
end

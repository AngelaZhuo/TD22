...
function superflex_TD19_EPhys(phase, odorcue_odors, rewardcue_odors, COMPort, fname,setup)%, JitterButton)
...
%% selection of parameters according to 'phase' input argument
    ...
    [chapter, session.trialmatrix,ex_vectors_cur]=do_constructTrialMatrix_TD19(phase, odorcue_odors, rewardcue_odors);
